...
- Capture the canonical game vision and design direction
- Keep planning artifacts in one place for product, design, and development alignment
- Document scope, priorities, and decision-making inputs for future production work
...
Do not treat this repository as an open-source template or public contribution project.

## Current Status

This repository currently contains planning and design documentation for the game concept.

The deliverable in scope here is the documentation itself:

- product framing
- game systems definition
- progression and economy direction
- social and live-service design
- MVP and roadmap guidance

## Next Documentation Priorities

- turn the high-level design into feature specs
- define the MVP in production-ready detail
- document economy formulas and balancing assumptions
- outline backend, client, and live-ops requirements
