...
Use these docs as the source of truth for:
...
**All documentation in this folder is proprietary.**

This project is not open source. Do not redistribute, reuse, or publish these materials as if they were public-domain or permissively licensed content.
